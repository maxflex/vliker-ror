...
RSpec.describe "gift_codes/new", type: :view do
  before(:each) do
    assign(:gift_code, GiftCode.new(
      :good => nil,
      :code => "MyString",
      :activated => false,
      :user => nil
  ...
  it "renders new gift_code form" do
    render

    assert_select "form[action=?][method=?]", gift_codes_path, "post" do
